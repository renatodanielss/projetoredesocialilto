...
alter table usagelog add hits integer;
...
alter table content add futureint1 integer;

alter table content add futureint2 integer;

alter table content add futureint3 integer;
...
alter table content_archive add futureint1 integer;

alter table content_archive add futureint2 integer;

alter table content_archive add futureint3 integer;
...
alter table content_public add futureint1 integer;

alter table content_public add futureint2 integer;

alter table content_public add futureint3 integer;
