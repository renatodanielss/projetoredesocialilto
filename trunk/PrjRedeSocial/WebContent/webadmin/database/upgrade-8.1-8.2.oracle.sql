...
alter table users add index_workspace clob;



alter table content add doctype clob;

alter table content_archive add doctype clob;

alter table content_public add doctype clob;

alter table contentgroups add doctype clob;

alter table contenttypes add doctype clob;

alter table productgroups add doctype clob;

alter table producttypes add doctype clob;

alter table websites add default_doctype clob;



alter table content_elements add element_order int;

alter table content_elements add element_params clob;

alter table content_archive_elements add element_order int;

alter table content_archive_elements add element_params clob;

alter table content_public_elements add element_order int;

alter table content_public_elements add element_params clob;



alter table workflow add workflow_program clob;
