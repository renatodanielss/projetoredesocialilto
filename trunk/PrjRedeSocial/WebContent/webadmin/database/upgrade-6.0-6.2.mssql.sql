...
update content set new_product_email = substring(product_email,1,10)

alter table content drop column product_email

sp_rename 'content.new_product_email', 'product_email', 'COLUMN'

alter table content_archive add new_product_email varchar(10)

update content_archive set new_product_email = substring(product_email,1,10)

alter table content_archive drop column product_email

sp_rename 'content_archive.new_product_email', 'product_email', 'COLUMN'

alter table content_public add new_product_email varchar(10)

update content_public set new_product_email = substring(product_email,1,10)

alter table content_public drop column product_email

sp_rename 'content_public.new_product_email', 'product_email', 'COLUMN'

alter table orderitems add new_product_email varchar(10)

update orderitems set new_product_email = substring(product_email,1,10)

alter table orderitems drop column product_email

sp_rename 'orderitems.new_product_email', 'product_email', 'COLUMN'
