...
alter table content alter column stylesheet varchar(255)

alter table content_archive alter column stylesheet varchar(255)

alter table content_public alter column stylesheet varchar(255)
