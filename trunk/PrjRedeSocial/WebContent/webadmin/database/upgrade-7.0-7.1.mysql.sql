...
update content set htmlbodyonload = concat('onload="', htmlbodyonload, '"') where htmlbodyonload is not null and htmlbodyonload <> ''

update content_archive set htmlbodyonload = concat('onload="', htmlbodyonload, '"') where htmlbodyonload is not null and htmlbodyonload <> ''

update content_public set htmlbodyonload = concat('onload="', htmlbodyonload, '"') where htmlbodyonload is not null and htmlbodyonload <> ''

alter table content add product_weight text

alter table content add product_volume text

alter table content add product_width text

alter table content add product_height text

alter table content add product_depth text

alter table content_archive add product_weight text

alter table content_archive add product_volume text

alter table content_archive add product_width text

alter table content_archive add product_height text

alter table content_archive add product_depth text

alter table content_public add product_weight text

alter table content_public add product_volume text

alter table content_public add product_width text

alter table content_public add product_height text

alter table content_public add product_depth text

alter table orderitems add product_weight text

alter table orderitems add product_volume text

alter table orderitems add product_width text

alter table orderitems add product_height text

alter table orderitems add product_depth text

alter table orderitems add shipping_description text

alter table orderitems add shipping_total text

alter table orderitems add tax_description text

alter table orderitems add tax_total text
...
alter table orders add discount_description text;

alter table orders add discount_total text;

alter table orderitems add discount_description text;

alter table orderitems add discount_total text;
