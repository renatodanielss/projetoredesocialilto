...
alter table content change product_email product_email varchar(10)

alter table content_archive change product_email product_email varchar(10)

alter table content_public change product_email product_email varchar(10)

alter table orderitems change product_email product_email varchar(10)

alter table usagelog change requestpath requestpath varchar(250)

alter table content add summary longtext
...
alter table content_archive add summary longtext
...
alter table content_public add summary longtext
...
alter table orderitems add summary longtext
