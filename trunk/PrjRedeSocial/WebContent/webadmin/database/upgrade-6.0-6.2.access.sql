...
alter table content alter column product_email varchar(10)

alter table content_archive alter column product_email varchar(10)

alter table content_public alter column product_email varchar(10)

alter table orderitems alter column product_email varchar(10)

alter table usagelog alter column requestpath varchar(250)

alter table content add summary memo
...
alter table content add product_delivery memo

alter table content add product_user memo

alter table content add product_page varchar(10)

alter table content add product_program memo

alter table content add product_hosting memo

alter table content add product_options memo

alter table content_archive add summary memo
...
alter table content_archive add product_delivery memo

alter table content_archive add product_user memo

alter table content_archive add product_page varchar(10)

alter table content_archive add product_program memo

alter table content_archive add product_hosting memo

alter table content_archive add product_options memo

alter table content_public add summary memo
...
alter table content_public add product_delivery memo

alter table content_public add product_user memo

alter table content_public add product_page varchar(10)

alter table content_public add product_program memo

alter table content_public add product_hosting memo

alter table content_public add product_options memo
...
alter table orderitems add summary memo
...
alter table orderitems add product_delivery memo

alter table orderitems add product_user memo

alter table orderitems add product_page varchar(10)

alter table orderitems add product_program memo

alter table orderitems add product_hosting memo

alter table orderitems add product_options memo
