...
alter table content alter column stylesheet type varchar(255)

alter table content_archive alter column stylesheet type varchar(255)

alter table content_public alter column stylesheet type varchar(255)
