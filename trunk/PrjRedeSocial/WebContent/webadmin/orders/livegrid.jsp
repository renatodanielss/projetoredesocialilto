...
//		columnSpecs : [,,,,,{type:'date'},{type:'date'}],
	...
	buffer=new Rico.Buffer.AjaxSQL(document.location.protocol + '//' + document.location.host + '/<%= mytext.display("adminpath") %>/orders/index.xml.jsp?' + Math.random() + '&ecommerce=<%= html.encodeHtmlEntities(myrequest.getParameter("ecommerce")) %>&', {
