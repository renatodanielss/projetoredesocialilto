...
module.add(				   "Manual Payment Handling Module v1.0" );
...
modulePaymentTitle.add(			   "Manual Payment Handling" );
modulePaymentOptions.add(		   "Handle order and payment details manually.");
