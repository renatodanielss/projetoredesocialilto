...
if (request.getAttribute("content") != null) {
	...
	String myrevision = content.getRevision();
	myrevision += "" + content.getUpdated() + " Content: " + content.getTitle() + " [" + content.getId() + "] " + "Workflow: " + workflow.getTitle() + " : " + workflow.getAction() + " : " + workflow.getFromState() + " => " + workflow.getToState() + "\r\n";
	content.setRevision(myrevision);
...
if (request.getAttribute("order") != null) {
	...
	String myrevision = order.getRevision();
	myrevision += "" + order.getUpdated() + " Order: [" + order.getId() + "] " + "Workflow: " + "Orders Administration" + " : " + workflow.getAction() + " : " + workflow.getFromState() + " => " + workflow.getToState() + "\r\n";
	order.setRevision(myrevision);
