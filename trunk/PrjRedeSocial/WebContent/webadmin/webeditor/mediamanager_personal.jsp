...
<meta http-equiv="Copyright" content="(C) 2002-2010 - Asbru Ltd. - www.asbrusoft.com">
...
document.title = HtmlDecode(Text('media_title'));
...
function initform(link) {
	...
	if (link == null) {
		...
		usemap = requestParameter("usemap");
		...
		if (document.linkform.usemap) usemap = document.linkform.usemap.value;
	...
	if (document.linkform.usemap) document.linkform.usemap.value = usemap;
...
function linkit() {
	...
	if (document.linkform.usemap) { usemap = document.linkform.usemap.value; } else { usemap = ""; }
	...
	if (mediaclass == "flash") {
		...
		webeditor.insertImage(url, border, text, width, height, vspace, hspace, align, htmlclass, htmlid, onmouseover, onmouseout, usemap);
	}
...
<form name="linkform" onSubmit="linkit()">
<input type="hidden" name="usemap" value="">
<table summary="" width="100%" border="0" class="dtree">
	<tr align="left" valign="top"> 
		<td colspan="4" class="webeditor_window_title"><script type="text/javascript">document.write(Text('media_title'));</script></td>
	</tr>
	<tr align="left" valign="top"> 
		<td colspan="4">
			<fieldset>
					...
					<tr>
						...
						<td class="webeditor_window_value"> 
							<select name="quicklink" style="width: 100%;" onChange="javascript:initform(this.options[this.selectedIndex].value)">
								...
								<option value="http://www.asbrusoft.com/webadmin/logo.gif">Asbru logo
							</select>
						</td>
					</tr>
					<tr>
						<td class="webeditor_window_attribute"><script type="text/javascript">document.write(Text('media_url_type'));</script></td>
	...
	<tr align="left" valign="top"> 
		<td colspan="2" width="50%">
			<fieldset>
			<legend class="webeditor_window_heading"><script type="text/javascript">document.write(Text('media_size'));</script></legend>
				<table summary="" width="100%">
					<tr>
						<td class="webeditor_window_attribute"><script type="text/javascript">document.write(Text('media_size_width'));</script></td>
						<td class="webeditor_window_value"> 
							<input type="text" name="width" size="5" value="">
						</td>
					</tr>
					<tr>
						<td class="webeditor_window_attribute"><script type="text/javascript">document.write(Text('media_size_height'));</script></td>
						<td class="webeditor_window_value"> 
							<input type="text" name="height" size="5" value="">
						</td>
					</tr>
					<tr>
						<td class="webeditor_window_attribute"><script type="text/javascript">document.write(Text('media_size_border'));</script></td>
						<td class="webeditor_window_value"> 
		...
		<td colspan="2" width="50%">
			<fieldset>
			<legend class="webeditor_window_heading"><script type="text/javascript">document.write(Text('media_spacing_alignment'));</script></legend>
				<table summary="" width="100%">
					<tr>
						<td class="webeditor_window_attribute"><script type="text/javascript">document.write(Text('media_spacing_vertical'));</script></td>
						<td class="webeditor_window_value"> 
							<input type="text" name="vspace" size="5" value="">
						</td>
					</tr>
					<tr>
						<td class="webeditor_window_attribute"><script type="text/javascript">document.write(Text('media_spacing_horizontal'));</script></td>
						<td class="webeditor_window_value"> 
							<input type="text" name="hspace" size="5" value="">
						</td>
					</tr>
					<tr>
						<td class="webeditor_window_attribute"><script type="text/javascript">document.write(Text('media_alignment'));</script></td>
						<td class="webeditor_window_value"> 
							<select name="align">
								<option value=""><script type="text/javascript">document.write(Text('media_alignment_default'));</script>
								<option value="left"><script type="text/javascript">document.write(Text('media_alignment_left'));</script>
								<option value="right"><script type="text/javascript">document.write(Text('media_alignment_right'));</script>
								<option value="top"><script type="text/javascript">document.write(Text('media_alignment_top'));</script>
								<option value="bottom"><script type="text/javascript">document.write(Text('media_alignment_bottom'));</script>
								<option value="middle"><script type="text/javascript">document.write(Text('media_alignment_middle'));</script>
								<option value="absmiddle"><script type="text/javascript">document.write(Text('media_alignment_absmiddle'));</script>
							</select>
						</td>
					</tr>
				</table>
	...
	<tr align="left" valign="top"> 
		<td colspan="4">
			<fieldset>
			<legend class="webeditor_window_heading"><script type="text/javascript">document.write(Text('media_alt'));</script></legend>
				<table summary="" width="100%">
					<tr>
						<td class="webeditor_window_attribute"><script type="text/javascript">document.write(Text('media_alt_text'));</script></td>
						<td class="webeditor_window_value"> 
	...
	<tr align="left" valign="top"> 
		<td colspan="4">
			<fieldset>
			<legend class="webeditor_window_heading"><script type="text/javascript">document.write(Text('media_events'));</script></legend>
				<table summary="" width="100%">
					<tr>
						<td class="webeditor_window_attribute"><script type="text/javascript">document.write(Text('media_events_onmouseover'));</script></td>
						<td class="webeditor_window_value"> 
							<input type="text" name="htmlonmouseover" size="20" value="">
						</td>
						<td></td>
						<td class="webeditor_window_attribute"><script type="text/javascript">document.write(Text('media_events_onmouseout'));</script></td>
						<td class="webeditor_window_value"> 
