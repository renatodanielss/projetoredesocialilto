...
if (browserIs("Opera")) {
	...
	webeditor.majorVersion = parseInt(webeditor.minorVersion);
	webeditor.type = "textarea";
} else if (browserIs("Safari") && browserIs("iPhone") && (browserIs(" OS 5_") || browserIs(" OS 6_") || browserIs(" OS 7_") || browserIs(" OS 8_"))) {
	webbrowser = "Safari";
	webeditor.minorVersion = parseFloat(versionIs());
	webeditor.majorVersion = parseInt(webeditor.minorVersion);
	...
	webeditor.majorVersion = parseInt(webeditor.minorVersion);
	webeditor.type = "textarea";
} else if (browserIs("Safari") && browserIs("iPad") && (browserIs(" OS 5_") || browserIs(" OS 6_") || browserIs(" OS 7_") || browserIs(" OS 8_"))) {
	webbrowser = "Safari";
	webeditor.minorVersion = parseFloat(versionIs());
	webeditor.majorVersion = parseInt(webeditor.minorVersion);
	webeditor.type = "safari";
