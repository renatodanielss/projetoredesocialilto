...
if (typeof(webeditor) == "undefined") {
	document.write('<script type="text/javascript" src="properties' + webeditor_properties + '.js"></script>');
} else {
	document.write('<script type="text/javascript" src="' + webeditor.rootpath + 'properties' + webeditor_properties + '.js"></script>');
}
...
function HtmlDecode(encoded) {
	...
	for (var i=0; i<l; i++) {
		...
		if (ch == '&') {
			var j = encoded.indexOf(';', i+1);
			if (j > 0) {
				var entity = encoded.substring(i + 1, j);
