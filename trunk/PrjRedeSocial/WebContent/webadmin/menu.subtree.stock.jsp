...
if (id.startsWith("DEBUG")) {
	...
	if ((! single_menu_selection) && (myparentid.equals(""))) {
		...
		String mytype = "page";
		String myselected = "";
		if ((id.startsWith("menuitem_content_pages_bundles")) && (reqcontentclass.equals("page")) && (reqcontentbundle.equals(" "))) {
			myselected += "jstree-wcm-menu-selected";
		} else if ((id.startsWith("menuitem_content_elements_bundles")) && ((! reqcontentclass.equals("page,element,template,stylesheet,script")) && (! reqcontentclass.equals("page")) && (! reqcontentclass.equals("template")) && (! reqcontentclass.equals("stylesheet")) && (! reqcontentclass.equals("script")) && (! reqcontentclass.equals("image")) && (! reqcontentclass.equals("file")) && (! reqcontentclass.equals("link"))) && (reqcontentbundle.equals(" "))) {
			myselected += "jstree-wcm-menu-selected";
		} else if ((id.startsWith("menuitem_library_images_bundles")) && (reqcontentclass.equals("image")) && (reqcontentbundle.equals(" "))) {
			myselected += "jstree-wcm-menu-selected";
		} else if ((id.startsWith("menuitem_library_files_bundles")) && (reqcontentclass.equals("file")) && (reqcontentbundle.equals(" "))) {
			myselected += "jstree-wcm-menu-selected";
		} else if ((id.startsWith("menuitem_library_links_bundles")) && (reqcontentclass.equals("link")) && (reqcontentbundle.equals(" "))) {
			myselected += "jstree-wcm-menu-selected";
		} else if ((id.startsWith("menuitem_ecommerce_products_bundles")) && (reqcontentclass.equals("product")) && (reqcontentbundle.equals(" "))) {
			myselected += "jstree-wcm-menu-selected";
		}
%>
...
%><%
	...
	for (int i=0; i<rows.size(); i++) {
		...
		String mytype = "page";
		String myselected = "";
		if ((id.startsWith("menuitem_content_pages_bundles")) && (reqcontentclass.equals("page")) && (reqcontentbundle.equals(mycontentbundle))) {
			myselected += "jstree-wcm-menu-selected";
		} else if ((id.startsWith("menuitem_content_elements_bundles")) && ((! reqcontentclass.equals("page,element,template,stylesheet,script")) && (! reqcontentclass.equals("page")) && (! reqcontentclass.equals("template")) && (! reqcontentclass.equals("stylesheet")) && (! reqcontentclass.equals("script")) && (! reqcontentclass.equals("image")) && (! reqcontentclass.equals("file")) && (! reqcontentclass.equals("link"))) && (reqcontentbundle.equals(mycontentbundle))) {
			myselected += "jstree-wcm-menu-selected";
		} else if ((id.startsWith("menuitem_library_images_bundles")) && (reqcontentclass.equals("image")) && (reqcontentbundle.equals(mycontentbundle))) {
			myselected += "jstree-wcm-menu-selected";
		} else if ((id.startsWith("menuitem_library_files_bundles")) && (reqcontentclass.equals("file")) && (reqcontentbundle.equals(mycontentbundle))) {
			myselected += "jstree-wcm-menu-selected";
		} else if ((id.startsWith("menuitem_library_links_bundles")) && (reqcontentclass.equals("link")) && (reqcontentbundle.equals(mycontentbundle))) {
			myselected += "jstree-wcm-menu-selected";
		} else if ((id.startsWith("menuitem_ecommerce_products_bundles")) && (reqcontentclass.equals("product")) && (reqcontentbundle.equals(mycontentbundle))) {
			myselected += "jstree-wcm-menu-selected";
		}
%>
<li class="<%= myrelations %>" rel="<%= mytype %>" id="menuitem_content_<%= mycontentclass %>s_bundles_<%= myid %>"><a class="<%= myselected %>" href="/<%= mytext.display("adminpath") %>/content/index.jsp?contentpackage=<%= URLEncoder.encode(contentpackage, myconfig.get(db, "charset")) %>&contentclass=<%= mycontentclass %>&contentbundle=<%= URLEncoder.encode(mycontentbundle, myconfig.get(db, "charset")) %>&contentgroup=<%= URLEncoder.encode(contentgroup, myconfig.get(db, "charset")) %>&contenttype=<%= URLEncoder.encode(contenttype, myconfig.get(db, "charset")) %>&status=<%= URLEncoder.encode(status, myconfig.get(db, "charset")) %>&stock=<%= URLEncoder.encode(stock, myconfig.get(db, "charset")) %>&version=<%= URLEncoder.encode(version) %>&menu=<%= URLEncoder.encode(menu, myconfig.get(db, "charset")) %>&" title="<%= mytitle %>"><%= mytitle %></a></li>
...
<%
	...
	if (! single_menu_selection) {
		...
		String mytype = "page";
		String myselected = "";
		if ((id.startsWith("menuitem_content_pages_versions")) && (reqcontentclass.equals("page")) && (reqversion.equals(" "))) {
			myselected += "jstree-wcm-menu-selected";
		} else if ((id.startsWith("menuitem_content_elements_versions")) && ((! reqcontentclass.equals("page,element,template,stylesheet,script")) && (! reqcontentclass.equals("page")) && (! reqcontentclass.equals("template")) && (! reqcontentclass.equals("stylesheet")) && (! reqcontentclass.equals("script")) && (! reqcontentclass.equals("image")) && (! reqcontentclass.equals("file")) && (! reqcontentclass.equals("link"))) && (reqversion.equals(" "))) {
			myselected += "jstree-wcm-menu-selected";
		} else if ((id.startsWith("menuitem_library_images_versions")) && (reqcontentclass.equals("image")) && (reqversion.equals(" "))) {
			myselected += "jstree-wcm-menu-selected";
		} else if ((id.startsWith("menuitem_library_files_versions")) && (reqcontentclass.equals("file")) && (reqversion.equals(" "))) {
			myselected += "jstree-wcm-menu-selected";
		} else if ((id.startsWith("menuitem_library_links_versions")) && (reqcontentclass.equals("link")) && (reqversion.equals(" "))) {
			myselected += "jstree-wcm-menu-selected";
		} else if ((id.startsWith("menuitem_ecommerce_products_versions")) && (reqcontentclass.equals("product")) && (reqversion.equals(" "))) {
			myselected += "jstree-wcm-menu-selected";
		}
%>
...
%><%
	...
	while (versions.records(db, "")) {
		if ((! myconfig.get(db, "hide_accessrestricted_menu_items").equals("yes")) || versions.getAccessRestrictions(mysession.get("administrator"), mysession.get("userid"), mysession.get("username"), mysession.get("usertype"), mysession.get("usergroup"), mysession.get("usertypes"), mysession.get("usergroups"), db, myconfig)) {
			...
			String mytype = "page";
			String myselected = "";
			if ((id.startsWith("menuitem_content_pages_versions")) && (reqcontentclass.equals("page")) && (reqversion.equals(myversion))) {
				myselected += "jstree-wcm-menu-selected";
			} else if ((id.startsWith("menuitem_content_elements_versions")) && ((! reqcontentclass.equals("page,element,template,stylesheet,script")) && (! reqcontentclass.equals("page")) && (! reqcontentclass.equals("template")) && (! reqcontentclass.equals("stylesheet")) && (! reqcontentclass.equals("script")) && (! reqcontentclass.equals("image")) && (! reqcontentclass.equals("file")) && (! reqcontentclass.equals("link"))) && (reqversion.equals(myversion))) {
				myselected += "jstree-wcm-menu-selected";
			} else if ((id.startsWith("menuitem_library_images_versions")) && (reqcontentclass.equals("image")) && (reqversion.equals(myversion))) {
				myselected += "jstree-wcm-menu-selected";
			} else if ((id.startsWith("menuitem_library_files_versions")) && (reqcontentclass.equals("file")) && (reqversion.equals(myversion))) {
				myselected += "jstree-wcm-menu-selected";
			} else if ((id.startsWith("menuitem_library_links_versions")) && (reqcontentclass.equals("link")) && (reqversion.equals(myversion))) {
				myselected += "jstree-wcm-menu-selected";
			} else if ((id.startsWith("menuitem_ecommerce_products_versions")) && (reqcontentclass.equals("product")) && (reqversion.equals(myversion))) {
				myselected += "jstree-wcm-menu-selected";
			}
%>
<li class="<%= myrelations %>" rel="<%= mytype %>" id="<%= mycontentclass %>version_<%= myid %>"><a class="<%= myselected %>" href="/<%= mytext.display("adminpath") %>/content/index.jsp?contentpackage=<%= URLEncoder.encode(contentpackage, myconfig.get(db, "charset")) %>&contentclass=<%= mycontentclass %>&contentbundle=<%= URLEncoder.encode(contentbundle, myconfig.get(db, "charset")) %>&contentgroup=<%= URLEncoder.encode(contentgroup, myconfig.get(db, "charset")) %>&contenttype=<%= URLEncoder.encode(contenttype, myconfig.get(db, "charset")) %>&status=<%= URLEncoder.encode(status, myconfig.get(db, "charset")) %>&stock=<%= URLEncoder.encode(stock, myconfig.get(db, "charset")) %>&version=<%= URLEncoder.encode(myversion, myconfig.get(db, "charset")) %>&menu=<%= URLEncoder.encode(menu, myconfig.get(db, "charset")) %>&" title="<%= mytitle %>"><%= mytitle %></a></li>
...
<%
	...
	if ((! single_menu_selection) && (myparentid.equals(""))) {
		...
		String mytype = "page";
		String myselected = "";
		if ((id.startsWith("menuitem_ecommerce_products_groups")) && (reqcontentclass.equals("product")) && (reqcontentgroup.equals(" "))) {
			myselected += "jstree-wcm-menu-selected";
		}
%>
<li class="<%= myrelations %>" rel="<%= mytype %>" id="<%= mycontentclass %>group_<%= myid %>"><a class="<%= myselected %>" href="/<%= mytext.display("adminpath") %>/content/index.jsp?contentpackage=<%= URLEncoder.encode(contentpackage, myconfig.get(db, "charset")) %>&contentclass=<%= mycontentclass %>&contentbundle=<%= URLEncoder.encode(contentbundle, myconfig.get(db, "charset")) %>&contentgroup=<%= URLEncoder.encode(mycontentgroup, myconfig.get(db, "charset")) %>&contenttype=<%= URLEncoder.encode(contenttype, myconfig.get(db, "charset")) %>&status=<%= URLEncoder.encode(status, myconfig.get(db, "charset")) %>&stock=<%= URLEncoder.encode(stock, myconfig.get(db, "charset")) %>&version=<%= URLEncoder.encode(version) %>&menu=<%= URLEncoder.encode(menu, myconfig.get(db, "charset")) %>&" title="<%= mytitle %>"><%= mytitle %></a></li>
...
%><%
	String SQL = "select * from productgroups where (parentgroup is null) or (parentgroup='') order by productgroup";
	if (! myparentid.equals("")) {
	...
	while (contentgroups.records(db, "")) {
		if ((! myconfig.get(db, "hide_accessrestricted_menu_items").equals("yes")) || contentgroups.getAccessRestrictions(mysession.get("administrator"), mysession.get("userid"), mysession.get("username"), mysession.get("usertype"), mysession.get("usergroup"), mysession.get("usertypes"), mysession.get("usergroups"), db, myconfig)) {
			...
			String mytype = "page";
			String myselected = "";
			if ((id.startsWith("menuitem_ecommerce_products_groups")) && (reqcontentclass.equals("product")) && (reqcontentgroup.equals(mycontentgroup))) {
				myselected += "jstree-wcm-menu-selected";
			}
...
<%
	...
	if ((! single_menu_selection) && (myparentid.equals(""))) {
		...
		String mytype = "page";
		String myselected = "";
		if ((id.startsWith("menuitem_ecommerce_stock_groups")) && (reqcontentclass.equals("product")) && (reqcontentgroup.equals(" ")) && (myrequest.getRequestURI().indexOf("stock.jsp")>=0)) {
			myselected += "jstree-wcm-menu-selected";
		}
%>
...
%><%
	...
	while (contentgroups.records(db, "")) {
		if ((! myconfig.get(db, "hide_accessrestricted_menu_items").equals("yes")) || contentgroups.getAccessRestrictions(mysession.get("administrator"), mysession.get("userid"), mysession.get("username"), mysession.get("usertype"), mysession.get("usergroup"), mysession.get("usertypes"), mysession.get("usergroups"), db, myconfig)) {
			...
			String mytype = "page";
			String myselected = "";
			if ((id.startsWith("menuitem_ecommerce_stock_groups")) && (reqcontentclass.equals("product")) && (reqcontentgroup.equals(mycontentgroup)) && (myrequest.getRequestURI().indexOf("stock.jsp")>=0)) {
				myselected += "jstree-wcm-menu-selected";
			}
			descendents = db.query_value("select count(*) from productgroups where parentgroup='" + Common.SQL_clean(mycontentgroup) + "'");
			if (descendents > 0) {
...
<%
	...
	if ((! single_menu_selection) && (myparentid.equals(""))) {
		...
		String mytype = "page";
		String myselected = "";
		if ((id.startsWith("menuitem_ecommerce_products_types")) && (reqcontentclass.equals("product")) && (reqcontenttype.equals(" "))) {
			myselected += "jstree-wcm-menu-selected";
		}
%>
...
%><%
	String SQL = "select * from producttypes where (parenttype is null) or (parenttype='') order by producttype";
	if (! myparentid.equals("")) {
	...
	while (contenttypes.records(db, "")) {
		if ((! myconfig.get(db, "hide_accessrestricted_menu_items").equals("yes")) || contenttypes.getAccessRestrictions(mysession.get("administrator"), mysession.get("userid"), mysession.get("username"), mysession.get("usertype"), mysession.get("usergroup"), mysession.get("usertypes"), mysession.get("usergroups"), db, myconfig)) {
			...
			String mytype = "page";
			String myselected = "";
			if ((id.startsWith("menuitem_ecommerce_products_types")) && (reqcontentclass.equals("product")) && (reqcontenttype.equals(mycontenttype))) {
				myselected += "jstree-wcm-menu-selected";
			}
...
<%
	...
	if ((! single_menu_selection) && (myparentid.equals(""))) {
		...
		String mytype = "page";
		String myselected = "";
		if ((id.startsWith("menuitem_ecommerce_stock_types")) && (reqcontentclass.equals("product")) && (reqcontenttype.equals(" ")) && (myrequest.getRequestURI().indexOf("stock.jsp")>=0)) {
			myselected += "jstree-wcm-menu-selected";
		}
%>
...
%><%
	...
	while (contenttypes.records(db, "")) {
		if ((! myconfig.get(db, "hide_accessrestricted_menu_items").equals("yes")) || contenttypes.getAccessRestrictions(mysession.get("administrator"), mysession.get("userid"), mysession.get("username"), mysession.get("usertype"), mysession.get("usergroup"), mysession.get("usertypes"), mysession.get("usergroups"), db, myconfig)) {
			...
			String mytype = "page";
			String myselected = "";
			if ((id.startsWith("menuitem_ecommerce_stock_types")) && (reqcontentclass.equals("product")) && (reqcontenttype.equals(mycontenttype)) && (myrequest.getRequestURI().indexOf("stock.jsp")>=0)) {
				myselected += "jstree-wcm-menu-selected";
			}
			descendents = db.query_value("select count(*) from producttypes where parenttype='" + Common.SQL_clean(mycontenttype) + "'");
			if (descendents > 0) {
