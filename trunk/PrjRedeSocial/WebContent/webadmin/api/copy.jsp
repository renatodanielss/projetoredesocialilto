...
// "/webadmin/api/copy.jsp" example/template file
// Modify this file to use your own custom cloud storage copy file functionality
...
//		System.out.println("DEBUG:/webadmin/api/copy.jsp:"+oldfilename+":::"+newfilename+":::"+service+":::"+rootpath);
		...
		if ((oldfilename.equals("")) || (newfilename.equals(""))) {
			...
			try {
				...
				System.out.println("DEBUG:ERROR:/webadmin/api/copy.jsp:"+oldfilename+":::"+newfilename+":::"+service+":::"+rootpath+":::"+e);
			}

		} else {

			// other cloud storage service - place your own custom program code here or include "copy.custom.jsp"
