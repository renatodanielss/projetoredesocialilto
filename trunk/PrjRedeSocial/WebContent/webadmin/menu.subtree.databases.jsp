...
} else if (id.startsWith("menuitem_databases_data")) {
...
//		if ((! myconfig.get(db, "hide_accessrestricted_menu_items").equals("yes")) || databases.getAccessRestrictions(mysession.get("administrator"), mysession.get("userid"), mysession.get("username"), mysession.get("usertype"), mysession.get("usergroup"), mysession.get("usertypes"), mysession.get("usergroups"), db, myconfig)) {
			...
			String mytype = "page";
			String myselected = "";
			if (myrequest.getParameter("database").equals(myid)) {
				myselected += "jstree-wcm-menu-selected";
			}
%>
<li class="<%= myrelations %>" rel="<%= mytype %>" id="menuitem_databases_data_<%= myid %>"><a class="<%= myselected %>" href="/<%= mytext.display("adminpath") %>/data/index.jsp?database=<%= myid %>&menu=<%= URLEncoder.encode(menu, myconfig.get(db, "charset")) %>&<%= Math.random() %>&" title="<%= mytitle %>"><%= mytitle %></a></li>
<%
//		}
	}
...
} else if (id.startsWith("menuitem_databases_export")) {
	String SQL = "select id, title from data order by title, id";
	Databases databases = new Databases(mytext);
	databases.records(mysession.get("administrator"), mysession.get("userid"), mysession.get("username"), mysession.get("usertype"), mysession.get("usergroup"), mysession.get("usertypes"), mysession.get("usergroups"), db, myconfig, SQL);
	while (databases.records(mysession.get("administrator"), mysession.get("userid"), mysession.get("username"), mysession.get("usertype"), mysession.get("usergroup"), mysession.get("usertypes"), mysession.get("usergroups"), db, myconfig, "")) {
//		if ((! myconfig.get(db, "hide_accessrestricted_menu_items").equals("yes")) || databases.getAccessRestrictions(mysession.get("administrator"), mysession.get("userid"), mysession.get("username"), mysession.get("usertype"), mysession.get("usergroup"), mysession.get("usertypes"), mysession.get("usergroups"), db, myconfig)) {
			...
			String mytype = "page";
			String myselected = "";
			if (myrequest.getParameter("export").equals(myid)) {
				myselected += "jstree-wcm-menu-selected";
			}
%>
<li class="<%= myrelations %>" rel="<%= mytype %>" id="menuitem_databases_export_<%= myid %>"><a class="<%= myselected %>" href="/<%= mytext.display("adminpath") %>/data/export.jsp?id=<%= myid %>&export=<%= myid %>&menu=<%= URLEncoder.encode(menu, myconfig.get(db, "charset")) %>&<%= Math.random() %>&" title="<%= mytitle %>"><%= mytitle %></a></li>
<%
//		}
	}
...
} else if (id.startsWith("menuitem_databases_import")) {
	String SQL = "select id, title from data order by title, id";
	Databases databases = new Databases(mytext);
	databases.records(mysession.get("administrator"), mysession.get("userid"), mysession.get("username"), mysession.get("usertype"), mysession.get("usergroup"), mysession.get("usertypes"), mysession.get("usergroups"), db, myconfig, SQL);
	while (databases.records(mysession.get("administrator"), mysession.get("userid"), mysession.get("username"), mysession.get("usertype"), mysession.get("usergroup"), mysession.get("usertypes"), mysession.get("usergroups"), db, myconfig, "")) {
//		if ((! myconfig.get(db, "hide_accessrestricted_menu_items").equals("yes")) || databases.getAccessRestrictions(mysession.get("administrator"), mysession.get("userid"), mysession.get("username"), mysession.get("usertype"), mysession.get("usergroup"), mysession.get("usertypes"), mysession.get("usergroups"), db, myconfig)) {
			...
			String mytype = "page";
			String myselected = "";
			if (myrequest.getParameter("import").equals(myid)) {
				myselected += "jstree-wcm-menu-selected";
			}
%>
<li class="<%= myrelations %>" rel="<%= mytype %>" id="menuitem_databases_import_<%= myid %>"><a class="<%= myselected %>" href="/<%= mytext.display("adminpath") %>/data/import.jsp?id=<%= myid %>&import=<%= myid %>&menu=<%= URLEncoder.encode(menu, myconfig.get(db, "charset")) %>&<%= Math.random() %>&" title="<%= mytitle %>"><%= mytitle %></a></li>
<%
//		}
	}
