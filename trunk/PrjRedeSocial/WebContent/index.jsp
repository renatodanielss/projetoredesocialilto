...
<head><% if (! cms.Page(myrequest.getParameter("id")).getServerFilename().equals("")) { %><base href="<%= myrequest.getProtocol() + myrequest.getServerName() + myrequest.getServerPort() + myconfig.getTemp("URLrootpath") + cms.Page(myrequest.getParameter("id")).getServerFilename() %>"<%= cms.XHTMLclosed %>><!--[if lte IE 6]></base><![endif]--><% } %>
