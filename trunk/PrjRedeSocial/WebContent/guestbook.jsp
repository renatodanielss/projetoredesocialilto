...
browseWebsite.doGuestbook(servletcontext, mysession, myrequest, myresponse, myconfig, db);
Page mypage = browseWebsite.getGuestbookPage(servletcontext, mysession, myrequest, myresponse, myconfig, db);
...
if (! myrequest.getParameter("id").equals("")) {
	...
	cms.CMSLog(myconfig.get(db, "default_guestbook_page"), "page", "");
}
