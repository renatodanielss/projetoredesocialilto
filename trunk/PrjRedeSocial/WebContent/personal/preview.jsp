<%@ include file="../webadmin.jsp" %><%@ page import="HardCore.UCmaintainContent" %><%@ page import="HardCore.Content" %><%@ page import="HardCore.Page" %><%@ page import="HardCore.MenuContent" %><%@ page import="HardCore.html" %><%@ page import="java.net.URLEncoder" %><%

UCmaintainContent maintainContent = new UCmaintainContent(mytext);
Page mypage = maintainContent.doPreviewPublic(servletcontext, DOCUMENT_ROOT, mysession, myrequest, myresponse, myconfig, db, website);
...
<html>
<head>
<base href="<%= myrequest.getProtocol() + myrequest.getServerName() + myrequest.getServerPort() + myconfig.getTemp("URLrootpath") %>personal/"<%= cms.XHTMLclosed %>><!--[if lte IE 6]></base><![endif]-->
