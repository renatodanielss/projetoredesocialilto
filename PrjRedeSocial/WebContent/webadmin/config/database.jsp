<%@ page buffer="none" %><% response.setContentType("text/html;charset=UTF-8"); %><%@ include file="../config.jsp" %>
...
<%
	...
	configureSystem.doLicenseRestrictions(db, myconfig);
	...
	Fileupload filepost = configureSystem.getFileupload();
%>
<%@ include file="database.jsp.html" %>
