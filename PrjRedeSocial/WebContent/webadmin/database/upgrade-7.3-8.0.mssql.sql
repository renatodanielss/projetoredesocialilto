...
alter table elements add parentelement varchar(255) null;

alter table elements add users_type varchar(255) null;

alter table elements add users_group varchar(255) null;

alter table elements add developers_type varchar(255) null;

alter table elements add developers_group varchar(255) null;

alter table elements add creators_type varchar(255) null;

alter table elements add creators_group varchar(255) null;

alter table elements add editors_type varchar(255) null;

alter table elements add editors_group varchar(255) null;

alter table elements add publishers_type varchar(255) null;

alter table elements add publishers_group varchar(255) null;

alter table elements add administrators_type varchar(255) null;

alter table elements add administrators_group varchar(255) null;

alter table elements add users_users text null;

alter table elements add developers_users text null;

alter table elements add creators_users text null;

alter table elements add editors_users text null;

alter table elements add publishers_users text null;

alter table elements add administrators_users text null;
...
alter table versions add parentversion varchar(255) null;

alter table versions add users_type varchar(255) null;

alter table versions add users_group varchar(255) null;

alter table versions add developers_type varchar(255) null;

alter table versions add developers_group varchar(255) null;

alter table versions add creators_type varchar(255) null;

alter table versions add creators_group varchar(255) null;

alter table versions add editors_type varchar(255) null;

alter table versions add editors_group varchar(255) null;

alter table versions add publishers_type varchar(255) null;

alter table versions add publishers_group varchar(255) null;

alter table versions add administrators_type varchar(255) null;

alter table versions add administrators_group varchar(255) null;

alter table versions add users_users text null;

alter table versions add developers_users text null;

alter table versions add creators_users text null;

alter table versions add editors_users text null;

alter table versions add publishers_users text null;

alter table versions add administrators_users text null;
...
alter table hostinggroups add parentgroup varchar(255) null;

alter table hostinggroups add users_type varchar(255) null;

alter table hostinggroups add users_group varchar(255) null;

alter table hostinggroups add developers_type varchar(255) null;

alter table hostinggroups add developers_group varchar(255) null;

alter table hostinggroups add creators_type varchar(255) null;

alter table hostinggroups add creators_group varchar(255) null;

alter table hostinggroups add editors_type varchar(255) null;

alter table hostinggroups add editors_group varchar(255) null;

alter table hostinggroups add publishers_type varchar(255) null;

alter table hostinggroups add publishers_group varchar(255) null;

alter table hostinggroups add administrators_type varchar(255) null;

alter table hostinggroups add administrators_group varchar(255) null;

alter table hostinggroups add users_users text null;

alter table hostinggroups add developers_users text null;

alter table hostinggroups add creators_users text null;

alter table hostinggroups add editors_users text null;

alter table hostinggroups add publishers_users text null;

alter table hostinggroups add administrators_users text null;
...
alter table hostingtypes add parenttype varchar(255) null;

alter table hostingtypes add users_type varchar(255) null;

alter table hostingtypes add users_group varchar(255) null;

alter table hostingtypes add developers_type varchar(255) null;

alter table hostingtypes add developers_group varchar(255) null;

alter table hostingtypes add creators_type varchar(255) null;

alter table hostingtypes add creators_group varchar(255) null;

alter table hostingtypes add editors_type varchar(255) null;

alter table hostingtypes add editors_group varchar(255) null;

alter table hostingtypes add publishers_type varchar(255) null;

alter table hostingtypes add publishers_group varchar(255) null;

alter table hostingtypes add administrators_type varchar(255) null;

alter table hostingtypes add administrators_group varchar(255) null;

alter table hostingtypes add users_users text null;

alter table hostingtypes add developers_users text null;

alter table hostingtypes add creators_users text null;

alter table hostingtypes add editors_users text null;

alter table hostingtypes add publishers_users text null;

alter table hostingtypes add administrators_users text null;
...
alter table content add unpublished varchar(20) null;

alter table content add unpublished_by varchar(255) null;

alter table content_archive add unpublished varchar(20) null;

alter table content_archive add unpublished_by varchar(255) null;

alter table content_public add unpublished varchar(20) null;

alter table content_public add unpublished_by varchar(255) null;
...
alter table content add contentbundle varchar(255) null;

alter table content_archive add contentbundle varchar(255) null;

alter table content_public add contentbundle varchar(255) null;
...
alter table users add index_content text null;

alter table users add index_library text null;

alter table users add index_product text null;

alter table users add index_order text null;

alter table users add index_databases text null;

alter table users add index_user text null;

alter table users add index_hosting text null;

alter table users add index_websites text null;

alter table users add menu_selection varchar(255) null;

alter table users add workspace_sections text null;

alter table users add statistics_reports text null;
...
alter table websites add default_page_nonexisting varchar(10) null;

alter table websites add default_page_unpublished varchar(10) null;

alter table websites add default_page_expired varchar(10) null;

alter table websites add default_login varchar(10) null;

alter table websites add default_searchresults_page varchar(10) null;

alter table websites add default_searchresults_entry varchar(10) null;

alter table websites add default_list_entry varchar(10) null;

alter table websites add default_publish_ready varchar(10) null;

alter table websites add default_register_confirm_page varchar(10) null;

alter table websites add default_register_notify_page varchar(10) null;

alter table websites add default_personal_admin_page varchar(10) null;

alter table websites add retrieve_password_page varchar(10) null;

alter table websites add retrieve_password_confirmation varchar(10) null;

alter table websites add retrieve_password_email varchar(10) null;

alter table websites add retrieve_password_error varchar(10) null;
...
alter table hosting add externalstorage text null;
...
alter table content add futurechar1 varchar(255) null;

alter table content add futurechar2 varchar(255) null;

alter table content add futurechar3 varchar(255) null;

alter table content add futuretext1 text null;

alter table content add futuretext2 text null;

alter table content add futuretext3 text null;

alter table content add futureint1 int null;

alter table content add futureint2 int null;

alter table content add futureint3 int null;

alter table content_archive add futurechar1 varchar(255) null;

alter table content_archive add futurechar2 varchar(255) null;

alter table content_archive add futurechar3 varchar(255) null;

alter table content_archive add futuretext1 text null;

alter table content_archive add futuretext2 text null;

alter table content_archive add futuretext3 text null;

alter table content_archive add futureint1 int null;

alter table content_archive add futureint2 int null;

alter table content_archive add futureint3 int null;

alter table content_public add futurechar1 varchar(255) null;

alter table content_public add futurechar2 varchar(255) null;

alter table content_public add futurechar3 varchar(255) null;

alter table content_public add futuretext1 text null;

alter table content_public add futuretext2 text null;

alter table content_public add futuretext3 text null;

alter table content_public add futureint1 int null;

alter table content_public add futureint2 int null;

alter table content_public add futureint3 int null;
