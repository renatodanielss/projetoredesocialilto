...
alter table usergroups add users_users clob;

alter table usergroups add creators_users clob;

alter table usergroups add editors_users clob;

alter table usergroups add publishers_users clob;

alter table usergroups add administrators_users clob;

alter table usergroups add subscribers_users clob;

alter table usertypes add users_users clob;

alter table usertypes add creators_users clob;

alter table usertypes add editors_users clob;

alter table usertypes add publishers_users clob;

alter table usertypes add administrators_users clob;

alter table usertypes add subscribers_users clob;
