...
alter table orders alter column order_quantity set data type int;

alter table orders add order_currency_base clob;

alter table orders add order_subtotal_base decimal(20,2);

alter table orders alter column order_subtotal set data type decimal(20,2);

alter table orders add discount_total_base decimal(20,2);

alter table orders alter column discount_total set data type decimal(20,2);

alter table orders add shipping_total_base decimal(20,2);

alter table orders alter column shipping_total set data type decimal(20,2);

alter table orders add tax_total_base decimal(20,2);

alter table orders alter column tax_total set data type decimal(20,2);

alter table orders add order_total_base decimal(20,2);

alter table orders alter column order_total set data type decimal(20,2);

alter table orderitems alter column item_quantity set data type int;
...
alter table orderitems alter column item_total set data type decimal(20,2);

alter table orderitems add discount_total_base decimal(20,2);

alter table orderitems alter column discount_total set data type decimal(20,2);

alter table orderitems add shipping_total_base decimal(20,2);

alter table orderitems alter column shipping_total set data type decimal(20,2);

alter table orderitems add tax_total_base decimal(20,2);

alter table orderitems alter column tax_total set data type decimal(20,2);
