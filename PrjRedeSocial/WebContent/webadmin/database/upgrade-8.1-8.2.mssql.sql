...
alter table users add index_workspace ntext null;



alter table content add doctype ntext null;

alter table content_archive add doctype ntext null;

alter table content_public add doctype ntext null;

alter table contentgroups add doctype ntext null;

alter table contenttypes add doctype ntext null;

alter table productgroups add doctype ntext null;

alter table producttypes add doctype ntext null;

alter table websites add default_doctype ntext null;



alter table content_elements add element_order int;

alter table content_elements add element_params ntext null;

alter table content_archive_elements add element_order int;

alter table content_archive_elements add element_params ntext null;

alter table content_public_elements add element_order int;

alter table content_public_elements add element_params ntext null;



alter table workflow add workflow_program ntext null;
