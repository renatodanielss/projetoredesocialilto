...
update content set htmlbodyonload = 'onload="' || htmlbodyonload || '"' where htmlbodyonload is not null

update content_archive set htmlbodyonload = 'onload="' || htmlbodyonload || '"' where htmlbodyonload is not null

update content_public set htmlbodyonload = 'onload="' || htmlbodyonload || '"' where htmlbodyonload is not null
