...
alter table elements add users_users clob;

alter table elements add developers_users clob;

alter table elements add creators_users clob;

alter table elements add editors_users clob;

alter table elements add publishers_users clob;

alter table elements add administrators_users clob;
...
alter table versions add users_users clob;

alter table versions add developers_users clob;

alter table versions add creators_users clob;

alter table versions add editors_users clob;

alter table versions add publishers_users clob;

alter table versions add administrators_users clob;
...
alter table hostinggroups add users_users clob;

alter table hostinggroups add developers_users clob;

alter table hostinggroups add creators_users clob;

alter table hostinggroups add editors_users clob;

alter table hostinggroups add publishers_users clob;

alter table hostinggroups add administrators_users clob;
...
alter table hostingtypes add users_users clob;

alter table hostingtypes add developers_users clob;

alter table hostingtypes add creators_users clob;

alter table hostingtypes add editors_users clob;

alter table hostingtypes add publishers_users clob;

alter table hostingtypes add administrators_users clob;
...
alter table users add index_content clob;

alter table users add index_library clob;

alter table users add index_product clob;

alter table users add index_order clob;

alter table users add index_databases clob;

alter table users add index_user clob;

alter table users add index_hosting clob;

alter table users add index_websites clob;

alter table users add menu_selection varchar(255);

alter table users add workspace_sections clob;

alter table users add statistics_reports clob;
...
alter table hosting add externalstorage clob;
...
alter table content add futuretext1 clob;

alter table content add futuretext2 clob;

alter table content add futuretext3 clob;
...
alter table content_archive add futuretext1 clob;

alter table content_archive add futuretext2 clob;

alter table content_archive add futuretext3 clob;
...
alter table content_public add futuretext1 clob;

alter table content_public add futuretext2 clob;

alter table content_public add futuretext3 clob;
