...
update content set product_stock_amount = cast(product_stock as integer) where product_stock is not null and product_stock <> '';
...
update content_archive set product_stock_amount = cast(product_stock as integer) where product_stock is not null and product_stock <> '';
...
update content_public set product_stock_amount = cast(product_stock as integer) where product_stock is not null and product_stock <> '';
...
alter table orders alter column order_quantity type int using order_quantity::int;

alter table orders add order_currency_base text;

alter table orders add order_subtotal_base decimal(20,2);

alter table orders alter column order_subtotal type decimal(20,2) using order_subtotal::decimal(20,2);

alter table orders add discount_total_base decimal(20,2);

alter table orders alter column discount_total type decimal(20,2) using discount_total::decimal(20,2);

alter table orders add shipping_total_base decimal(20,2);

alter table orders alter column shipping_total type decimal(20,2) using shipping_total::decimal(20,2);

alter table orders add tax_total_base decimal(20,2);

alter table orders alter column tax_total type decimal(20,2) using tax_total::decimal(20,2);

alter table orders add order_total_base decimal(20,2);

alter table orders alter column order_total type decimal(20,2) using order_total::decimal(20,2);

alter table orderitems alter column item_quantity type int using item_quantity::int;
...
alter table orderitems alter column item_total type decimal(20,2) using item_total::decimal(20,2);

alter table orderitems add discount_total_base decimal(20,2);

alter table orderitems alter column discount_total type decimal(20,2) using discount_total::decimal(20,2);

alter table orderitems add shipping_total_base decimal(20,2);

alter table orderitems alter column shipping_total type decimal(20,2) using shipping_total::decimal(20,2);

alter table orderitems add tax_total_base decimal(20,2);

alter table orderitems alter column tax_total type decimal(20,2) using tax_total::decimal(20,2);
