...
(function ($) {
	$.jstree.plugin("ui", {
		...
		_fn : { 
			...
			reselect : function () {
				// BEGIN - Added by Asbru Ltd. to prevent overriding "jstree-clicked" in initial html_data
				//if (this.data.ui.to_select === false) return;
				// END - Added by Asbru Ltd. to prevent overriding "jstree-clicked" in initial html_data
				var _this = this,
