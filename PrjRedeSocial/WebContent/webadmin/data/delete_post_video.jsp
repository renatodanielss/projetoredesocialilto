...
String idDeleteVideo = myrequest.getParameter("id"); //recupera do parametro o id do conteudo para deletar
...
maintainData.doDeleteVideo(mysession, db, idDeleteVideo);


System.out.println("Log - " + "execute delete_post_item - id do item deletado = " + idDeleteVideo);
