...
Rico.setPaths('<%= myrequest.getProtocol() + myrequest.getServerName() + myrequest.getServerPort() %>/<%= mytext.display("adminpath") %>/rico3/js/','<%= myrequest.getProtocol() + myrequest.getServerName() + myrequest.getServerPort() %>/<%= mytext.display("adminpath") %>/rico3/css/','<%= myrequest.getProtocol() + myrequest.getServerName() + myrequest.getServerPort() %>/<%= mytext.display("adminpath") %>/rico3/images/');
...
//		columnSpecs : [,,,,,{type:'date'},{type:'date'}],
	...
	buffer=new Rico.Buffer.AjaxSQL('<%= myrequest.getProtocol() + myrequest.getServerName() + myrequest.getServerPort() %>/<%= mytext.display("adminpath") %>/users/search.xml.jsp?' + Math.random() + '&redirect=<%= URLEncoder.encode(myrequest.getRequestURI(), myconfig.get(db, "charset")) %>&', {
