...
function initform(link) {
	...
	if (document.linkform.text) document.linkform.text.value = text.replace(new RegExp("([\t\r\n])", "i"), " ");
	if (document.linkform.htmlclass) document.linkform.htmlclass.value = htmlclass.replace(new RegExp("([\t\r\n])", "i"), " ");
	if (document.linkform.htmlid) document.linkform.htmlid.value = htmlid.replace(new RegExp("([\t\r\n])", "i"), " ");
}
...
function linkit() {
	...
	webeditor.insertHyperlink(url, target, text, htmlclass, htmlid);
				...
				<table summary="" width="100%">
					<tr>
						...
						<td class="webeditor_window_value"> 
							<select name="target">
								<option value="" selected>&nbsp;
								<option value="_self"><script type="text/javascript">document.write(Text('hyperlink_target_target_self'));</script>
								<option value="_parent"><script type="text/javascript">document.write(Text('hyperlink_target_target_parent'));</script>
								<option value="_top"><script type="text/javascript">document.write(Text('hyperlink_target_target_top'));</script>
								<option value="_blank"><script type="text/javascript">document.write(Text('hyperlink_target_target_blank'));</script>
							</select>
						</td>
					</tr>
				</table>
