	...
	if ((! root_path.equals("")) && (enable_upload.equals("yes")) && (request.getParameter("submit") != null)) {
		...
		if ((! section_path.equals("")) && (request.getParameter("action") != null))  {
			if ((request.getParameter("action").equals("Create")) && (request.getParameter("title") != null) && (! request.getParameter("title").equals(""))) {
				...
				java.io.File fh = new java.io.File(root_path + section_path + new_category);
				if (! fh.exists()) {
					fh.mkdirs();
				}
				...
				java.io.File fh = new java.io.File(root_path + section_path + old_category);
				java.io.File fh2 = new java.io.File(root_path + section_path + new_category);
...
%>
<%@ include file="mediacategory.jsp.html" %>
