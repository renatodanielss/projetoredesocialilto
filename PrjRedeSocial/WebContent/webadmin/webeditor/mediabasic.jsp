...
<%
out.write("<option value=\"example.boat.jpg\">Boat" + "\r\n");
out.write("<option value=\"example.flower.jpg\">Flower" + "\r\n");
out.write("<option value=\"example.foldedcorner.gif\">Folded corner" + "\r\n");
out.write("<option value=\"example.landscape.jpg\">Landscape" + "\r\n");
out.write("<option value=\"example.map.jpg\">Map" + "\r\n");
out.write("<option value=\"example.flashwave.swf\">Flash example" + "\r\n");
%>
							</select>
						</td>
					</tr>
				...
				<table summary="" width="100%">
					...
					<tr>
						...
						<td class="webeditor_window_value"> 
							<select name="align">
								<script type="text/javascript">
								document.write('<option value="">' + Text('media_alignment_default') + '');
								document.write('<option value="left">' + Text('media_alignment_left') + '');
								document.write('<option value="right">' + Text('media_alignment_right') + '');
								document.write('<option value="top">' + Text('media_alignment_top') + '');
								document.write('<option value="bottom">' + Text('media_alignment_bottom') + '');
								document.write('<option value="middle">' + Text('media_alignment_middle') + '');
								document.write('<option value="absmiddle">' + Text('media_alignment_absmiddle') + '');
								</script>
							</select>
						</td>
					</tr>
