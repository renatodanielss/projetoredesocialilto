...
module.add(			"Data-to-Page Import v1.0" );
...
moduleConfigIntroTitle.add(	"Data-to-Page Import" );
moduleConfigIntroText.add(	"Import CSV format data file to generate pages." );
moduleConfigMenuTitle.add(	"Data-to-Page Import" );
moduleConfigMenuLink.add(	"/" + mytext.display("adminpath") + "/module/csv2page/index.jsp?menu=config" );
...
modulePaymentTitle.add(		"" );
modulePaymentOptions.add(	"" );
